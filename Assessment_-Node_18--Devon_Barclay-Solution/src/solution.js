/*
  ...
  IMPORTANT NOTE: When running tests and/or submitting your solution in the Qualified Web IDE, make sure to add the top directory `@faker-js/` (i.e., @faker-js/faker) when requiring the `faker` package. Otherwise, it throws an error when testing a solution because it can't find it.
